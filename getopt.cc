 ...
 * getopt.cc
 *
 * From CSSC, Copyright (C) 1997, Free Software Foundation, Inc.
 *
 * Based on MySC, by Ross Ridge, which was placed in the Public Domain.
 * 
...
static const char rcs_id[] = "CSSC $Id: getopt.cc,v 1.4 1997/05/21 00:01:28 james Exp $";
#endif
